...
const DepartmentForm = () => {
  ...
  return (
    <Box component="form" onSubmit={handleSubmit} sx={{ '& .MuiTextField-root': { marginBottom: '1rem', width: '100%' }, maxWidth: '400px', margin: '0 auto' }}>
      <h2>{id ? 'Modifier le département' : 'Ajouter un département'}</h2>
      <TextField label="Nom du département" name="name" value={department.name} onChange={handleChange} required fullWidth />
